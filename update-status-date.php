		...
		<tr>
			...
			<td>
				...
				<form action="" method="post">
					...
					<!-- <div class="col-md-4">
						<button type="submit" name="update-as-admin" class="btn btn-large btn-block btn-success">Unavailable</button>
					</div>
					<div class="col-md-4">
						<button type="submit" name="update-as-subadmin" class="btn btn-large btn-block btn-success">Invalid Info</button>
					</div>
				</form> -->
...
<?php 
	if (isset($_POST['update'])) 
	{
		...
		$update = "update complaints set status='$status' where complaint_id='$complaint_id'";
		mysql_query($update);
