            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php 
                        ...
                        $select = "select * from complaints where date = '$date' AND room_no = '$hostel'";
                        ...
                        while ($res = mysql_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><center><a href="update-status-date-hostel.php?complaint-id=<?php echo $res['complaint_id'] ?>"><button type="button" class="btn btn-success">Update-Status</button></a></center></td>
                            </tr>
                        <?php  }
                     ?>
                </tbody>
