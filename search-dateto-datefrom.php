            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php 
                        ...
                        $select = "SELECT * FROM `server-complaints` WHERE date between '$datefrom' and '$dateto' ";
                        ...
                        while ($res = mysql_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><center><a href="update-status-server.php?complaint-id=<?php echo $res['complaint_id'] ?>"><button type="button" class="btn btn-success">Update-Status</button></a></center></td>
                            </tr>
                        <?php  }
                     ?>
                </tbody>
