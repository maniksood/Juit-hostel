        ...
        <head>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php 
                        $date = $_SESSION['date'];
                        $select = "select * from complaints where date = '$date'";
                        ...
                        while ($res = mysql_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><center><a href="update-status-date.php?complaint-id=<?php echo $res['complaint_id'] ?>"><button type="button" class="btn btn-success">Update-Status</button></a></center></td>
                            </tr>
                        <?php  }
                     ?>
                </tbody>
